...
do
    ...
    # Produce figure
    ./01_scripts/03_overwatch_figures.R "$OUTPUT_FOLDER"/overwatch_figure.data "$FIGURE_FOLDER"/overwatch_figure.pdf

    # Rsync to other computer
    rsync -avhP "$FIGURE_FOLDER"/overwatch_figure.pdf "$REMOTE"
